...
contract OnimaruTrendsetter is
    ERC721,
    Ownable,
    ERC721Burnable,
    ERC721Enumerable,
    AccessControl
{
    ...
    constructor(string memory baseTokenURI_)
        ERC721("Onimaru x NYLON JAPAN: Trendsetter", "ONIMARUTS")
    {
    ...
    function mint(address to, uint256 tokenId) public onlyRole(MINTER_ROLE) {
        require(totalSupply() < maxSupply, "Onimaru x NYLON JAPAN: Trendsetter: Sold out");
        _safeMint(to, tokenId);
    }
